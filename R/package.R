...
#' [PLINK](http://pngu.mgh.harvard.edu/~purcell/plink/), the whole genome
#' association analysis toolset. `BEDMatrix` objects are created by simply
...
#' large files with limited use of memory. Technically, a `BEDMatrix` is a
