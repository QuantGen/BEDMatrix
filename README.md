...
2. Create a new BEDMatrix object by passing in a path to the binary PED file (`path`), the number of individuals (`n`), and the number of SNPs (`p`): `m <- new('BEDMatrix', path = 'plink.bed', n = 100, p = 10000)`
